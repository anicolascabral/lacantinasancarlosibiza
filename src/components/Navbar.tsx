      ...
      >
        <div className="flex items-center justify-center gap-3 py-2.5 px-6">
          ...
          <span className="eyebrow" style={{ color: "var(--paper)", fontSize: "0.6rem", letterSpacing: "0.28em" }}>
            Próxima apertura · Sant Carles, Ibiza
          </span>
        </div>
      </div>
      {(() => {
          ...
          <div className="grid grid-cols-3 items-center px-6 md:px-10 py-4">
            ...
            <div className="flex items-center">
              <a
                ...
                className="hidden md:inline text-xs tracking-widest uppercase font-body font-bold transition-opacity hover:opacity-60"
            ...
            {/* Center — Logo appears only after scroll (hero has its own big logo) */}
